...
<div class="right" style="height: 573px;">
	...
	<div class="right_main">
        ...
        <?php if(is_array($brandData)): foreach($brandData as $key=>$vo): ?><tr>
			...
			<td style="background-color: rgb(255, 255, 255);"><a href="http://phpshe.com/demo/phpshe/brand/22" target="_blank"><img src="<?php echo ($vo["logo"]); ?>" style="border:width:140px;height:56px"></a></td>
