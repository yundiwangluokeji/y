...
<div class="right" style="height: 573px;">
	<div class="now" style="width: 1679px;">
		<a href="Brand management.html" class="sel">品牌列表（13）</a>
		<a href="/Admin/Brand/addBrand" id="fabu">添加品牌</a>
		<div class="clear"></div>
	</div>
	<div class="right_main">
		...
		<tbody><tr>
			...
			<th class="bgtt" width="60">排序
			</th><th class="bgtt" width="150">品牌名称</th>
			<th class="bgtt" width="150">品牌图片</th>
			<!-- <th class="bgtt">品牌简介</th> -->
			<th class="bgtt" width="110">操作</th>
		</tr>
        <?php if(is_array($brandData)): foreach($brandData as $key=>$vo): ?><tr>
			<td style="background-color: rgb(255, 255, 255);"><input type="checkbox" name="brand_id[]" value="<?php echo ($vo["brand_id"]); ?>"></td>
			<td style="background-color: rgb(255, 255, 255);"><?php echo ($vo["brand_id"]); ?></td>
			...
			<td style="background-color: rgb(255, 255, 255);"><a href="http://phpshe.com/demo/phpshe/brand/22" target="_blank"><?php echo ($vo["name"]); ?></a></td>
			<td style="background-color: rgb(255, 255, 255);"><a href="http://phpshe.com/demo/phpshe/brand/22" target="_blank"><img src="/Public/Admin/brand/<?php echo ($vo["logo"]); ?>" style="border:width:140px;height:56px"></a></td>
			<!-- <td class="aleft" valign="top" style="background-color: rgb(255, 255, 255);">妖精的口袋，与时尚紧密接轨的年轻女装品牌，在淘宝立足不久即登上了电子商务大舞台。妖精的口袋专注于打造独立、自信、优雅、小...</td> -->
			<td style="background-color: rgb(255, 255, 255);">
				<a href="/Admin/Brand/editBrand/brand_id/<?php echo ($vo["brand_id"]); ?>" class="admin_edit mar3">修改</a>
				<a href="/Admin/Brand/delBrand/brand_id/<?php echo ($vo["brand_id"]); ?>" class="admin_del" onclick="return pe_cfone(this, &#39;删除&#39;)">删除</a>
			</td>
	...
	<div class="right_bottom">
		<span class="fl mal10">
			...
			<button href="/Admin/Brand/delBrand" onclick="return pe_cfall(this, &#39;brand_id&#39;, &#39;form&#39;, &#39;批量删除&#39;)">批量删除</button>
			<button href="/Admin/Brand/updateBrand" onclick="pe_doall(this,&#39;form&#39;)">更新排序</button>
		</span>
