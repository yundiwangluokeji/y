...
<div class="content">
 ...
 <!-- 左边 -->
	...
	<div class="right_main">
		<form method="post" action="/Admin/Type/addType">
		...
		<tbody><tr>
			...
			<td><input type="text" name="info[name]" value="" class="inputall input250"></td>
		</tr>
		<!-- <tr>
			...
			<td>
				...
				<option value="0">=============== 无 ==============</option>
								<option value="49">时尚女装</option>
								<option value="51">　 ├ 连衣裙</option>
								<option value="52">　 ├ T恤</option>
								<option value="53">　 ├ 上装</option>
								<option value="54">　 ├ 下装</option>
								<option value="71">　 　　├ 尺寸</option>
								<option value="72">　 　　　　├ 超差</option>
								<option value="73">　 　　　　　　├ 123</option>
								<option value="74">　 　　　　　　　　├ 234</option>
								<option value="75">　 　　　　　　　　　　├ 345</option>
								<option value="76">　 　　　　　　　　　　　　├ 456</option>
		...
		<tr>
			...
			<td><input type="text" name="info[sorting]" value="0" class="inputall input80"></td>
		</tr>
		<!-- <tr>
		...
		<tr>
			<td>&nbsp;</td>
			<td>
				<input type="hidden" name="pe_token" value="185dbf0e05b36cd40737acb79e73f95c">
