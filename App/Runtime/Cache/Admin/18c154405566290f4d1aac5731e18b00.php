...
<div class="right" style="height: 849px;">
    ...
    <tr>
        ...
        <td width="250">
            <select name="info[class_id]" class="inputselect" style="width:100%">
                ...
                <?php if(is_array($typeData)): foreach($typeData as $key=>$v): ?><option value="<?php echo ($v["brand_id"]); ?>" <?php if($goodData["class_id"] == $v['brand_id']): ?>selected<?php endif; ?> ><?php echo ($v["name"]); ?></option><?php endforeach; endif; ?>
            </select>
        </td>
    ...
    <tr>
        ...
        <td colspan="3">
            <div>
                <img src="/Public/Admin/good/<?php echo ($goodData["images"]); ?>" class="fl" style="border:1px solid #ddd;width:140px;height:56px">
