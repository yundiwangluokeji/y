...
<div class="now" style="width: 1679px;">
	...
	<div class="right_main">
		<form method="post" enctype="multipart/form-data" action="/Admin/Config/editConfig">
		<table width="100%" border="0" cellspacing="0" cellpadding="0" class="wenzhang mat20">
		<tbody><tr>
			<td align="right" width="150">网站标题：</td>
			<td><input type="text" name="info[title]" value="<?php echo ($configData["title"]); ?>" class="inputall input500"></td>
		</tr>
		<tr>
			<td align="right">关 键 词：</td>
			<td><input type="text" name="info[keywords]" value="<?php echo ($configData["keywords"]); ?>" class="inputall input500"></td>
		</tr>
		<tr>
			<td align="right">网站描述：</td>
			<td><textarea name="info[description]" style="width:500px;height:100px;"><?php echo ($configData["description"]); ?></textarea></td>
		</tr>
		<tr>
			<td align="right">网站Logo：</td>
			<td>
								<p class="mab5"><img src="/Public/Admin/config/<?php echo ($configData["logo"]); ?>" height="60" style="border:1px solid #ddd"></p>
		...
		<tr>
			...
			<td>
								<p class="mab5"><img src="/Public/Admin/config/<?php echo ($configData["wechat"]); ?>" height="70" style="border:1px solid #ddd"></p>
								<p><input type="file" name="wechat"></p>
			</td>
		</tr>
		<tr>
			<td align="right">咨询电话：</td>
			<td><input type="text" name="info[tel]" value="<?php echo ($configData["tel"]); ?>" class="inputall input500"></td>
		</tr>
		<tr>
			<td align="right">咨询 Q Q：</td>
			<td><input type="text" name="info[qq]" value="<?php echo ($configData["qq"]); ?>" class="inputall input500"></td>
		</tr>
		<tr>
			<td align="right">版权所有：</td>
			<td><input type="text" name="info[copyright]" value="<?php echo ($configData["copyright"]); ?>" class="inputall input500"></td>
		</tr>
		<tr>
			<td align="right">备 案 号：</td>
			<td><input type="text" name="info[record_no]" value="<?php echo ($configData["record_no"]); ?>" class="inputall input500"></td>
		</tr>
		<tr>
			<td align="right">热门搜索：</td>
			<td><input type="text" name="info[hot]" value="<?php echo ($configData["hot"]); ?>" class="inputall input500"><span class="c888">（多个请用“,”隔开）</span></td>
		</tr>
		<tr>
			<td align="right">统计代码：</td>
			<td><textarea name="info[count]" style="width:500px;height:150px;"><?php echo ($configData["count"]); ?></textarea><span class="c888">（第三方流量统计代码）</span></td>
		</tr>
		<tr>
			<td>&nbsp;</td>
			<td>
