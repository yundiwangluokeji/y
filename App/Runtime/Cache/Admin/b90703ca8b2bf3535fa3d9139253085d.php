...
<div class="content">
	...
	<div class="right_main">
        ...
        <?php if(is_array($typeData)): foreach($typeData as $key=>$vo): ?><tr>
    			<td style="background-color: rgb(255, 255, 255);"><input type="checkbox" name="category_id[]" value="<?php echo ($vo["brand_id"]); ?>"></td>
    			...
    			<td style="background-color: rgb(255, 255, 255);">
    				<a href="/Admin/Type/editType/brand_id/<?php echo ($vo["brand_id"]); ?>" class="admin_edit mar3">修改</a>
    				<a href="/Admin/Type/delType/brand_id/<?php echo ($vo["brand_id"]); ?>" class="admin_del mar3" onclick="return pe_cfone(this, &#39;删除&#39;)">删除</a>
    				<a href="/Admin/Type/transferGood/brand_id/<?php echo ($vo["brand_id"]); ?>" class="admin_btn" onclick="return pe_dialog(this, &#39;批量转移商品&#39;, 400, 220)">转移商品</a>
    			</td>
