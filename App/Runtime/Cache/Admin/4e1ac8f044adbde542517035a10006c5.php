...
<div class="content">
	...
	<a href="<?php echo U('User/index');?>">会员列表</a>
        ...
        <a href="<?php echo U('User/withdrawal');?>" class="sel">提现申请</a>
	...
	<div class="right_main">
        ...
        <?php if(is_array($data)): foreach($data as $key=>$vo): ?><tr>
    			...
    			<td style="background-color: rgb(255, 255, 255);"><?php echo ($vo["usernames"]); ?></td>
    			...
    			<td style="background-color: rgb(255, 255, 255);">
                    <a class="shelvesBtn" data-id="<?php echo ($vo["id"]); ?>" data-status="<?php echo ($vo["res"]); ?>" style="cursor: pointer;"><?php echo ($vo["res"]); ?></a>
                </td>
    			<td style="background-color: rgb(255, 255, 255);"><?php echo ($vo["name"]); ?></td>
                <td style="background-color: rgb(255, 255, 255);"><?php echo ($vo["amount"]); ?></td>
    			<td style="background-color: rgb(255, 255, 255);"><?php echo ($vo["account"]); ?></td>
