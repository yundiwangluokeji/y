...
<div class="content">
	...
	<a href="<?php echo U('User/index');?>">会员列表</a>
		...
		<a href="<?php echo U('User/money');?>" class="sel">货币操作记录</a>
	...
	<div class="right_main">
		<div class="search">
			...
			操作者:<input type="text" name="name" value="" class="inputtext input150">
			操作ip：<input type="text" name="tname" value="" class="inputtext input150">
			操作结果：<input type="text" name="phone" value="" class="inputtext input150">
		...
		<tbody><tr>
			...
			<th class="bgtt" width="100">操作者</th>
			<th class="bgtt" width="120">货币</th>
			<th class="bgtt" width="120">操作ip</th>
			<th class="bgtt" width="120">操作地址</th>
			<th class="bgtt" width="120">操作结果</th>
			<th class="bgtt" width="120">操作内型</th>
			<th class="bgtt" width="120">操作信息</th>
			<th class="bgtt" width="120">操作时间</th>
		</tr>
        <?php if(is_array($data)): foreach($data as $key=>$vo): ?><tr>
    			...
    			<td style="background-color: rgb(255, 255, 255);"><?php echo ($vo["money"]); ?>元</td>
    			<td style="background-color: rgb(255, 255, 255);"><?php echo ($vo["ip"]); ?></td>
    			<td style="background-color: rgb(255, 255, 255);"><?php echo ($vo["address"]); ?></td>
    			<td style="background-color: rgb(255, 255, 255);"><?php echo ($vo["res"]); ?></td>
    			<td style="background-color: rgb(255, 255, 255);"><?php echo ($vo["type"]); ?></td>
    			<td class="num" style="background-color: rgb(255, 255, 255);"><?php echo ($vo["msg"]); ?></td>
