...
<div class="right" style="height: 849px;">
	...
	<div class="right_main">
		...
		<?php if(is_array($data)): foreach($data as $key=>$v): ?><tr>
			...
			<td class="num" style="background-color: rgb(255, 255, 255);"><span><?php echo ($v["login_time"]); ?></span></td>
			<td>

				<a href="<?php echo U('update',array('id'=>$v['id']));?>" class="admin_edit mar3">修改</a>
                <!-- <a href="<?php echo U('dels',array('id'=>$v['id']));?>" class="admin_del" onclick="return pe_cfone(this, &#39;删除&#39;)">删除</a> -->
				<a href="<?php echo U('dels',array('id'=>$v['id']));?>" class="admin_del mar3" onclick="return pe_cfone(this, '删除')">删除</a>
				<a href="Collection account.html" class="admin_btn mar3" target="_blank">账户</a>
				<a href="<?php echo U('User/address', array('id' => $v['id']));?>" class="admin_btn" target="_blank">地址</a>
				<a href="<?php echo U('User/money', array('id' => $v['id']));?>" class="admin_btn" target="_blank">货币</a>
				<a href="<?php echo U('User/topUp', array('id' => $v['id']));?>" class="admin_btn" target="_blank">充值</a>
				<a href="<?php echo U('User/withdrawal', array('id' => $v['id']));?>" class="admin_btn" target="_blank">提现</a>
				<a href="<?php echo U('User/loginLog', array('name' => $v['username']));?>" class="admin_btn" target="_blank">登录</a>
			</td>
	...
	<div class="right_bottom">
		<span class="fl mal10">
			...
			<button href="/Admin/User/dels" onclick="return pe_cfall(this, &#39;user_id&#39;, &#39;form&#39;, &#39;批量删除&#39;)">批量删除</button>
