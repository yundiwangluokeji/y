...
<div class="content">
	...
	<a href="<?php echo U('User/index');?>">会员列表</a>
		...
		<a href="<?php echo U('User/address');?>" class="sel">收货地址</a>
	...
	<div class="right_main">
		...
		<tbody><tr>
			...
			<th class="bgtt" width="200">收货地址</th>
			<th class="bgtt" width="130">添加日期</th>
		</tr>
        <?php if(is_array($addressRes)): foreach($addressRes as $key=>$vo): ?><tr>
    			...
    			<td class="num" style="background-color: rgb(255, 255, 255);"><?php echo ($vo["mobile"]); ?></td>
    			<td class="aleft" style="background-color: rgb(255, 255, 255);"><?php echo ($vo["province"]); ?> <?php echo ($vo["city"]); ?> <?php echo ($vo["district"]); ?> <?php echo ($vo["twon"]); ?> <?php echo ($vo["address"]); ?></td>
