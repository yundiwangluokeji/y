 ...
 <!-- 左边 -->
	...
	<div class="right_main">
		<div class="search">
			<form method="get" action="/Admin/Goods/index">
    			...
    			<select name="classification" class="selectmini">
                    ...
                    <?php if(is_array($typeAllData)): foreach($typeAllData as $key=>$v): ?><option value="<?php echo ($v["class_id"]); ?>"><?php echo ($v["name"]); ?></option><?php endforeach; endif; ?>
    			</select>
        ...
        <?php if(is_array($goodData)): foreach($goodData as $key=>$vo): ?><tr>
			...
			<td width="40" style="background-color: rgb(255, 255, 255);"><a href="" target="_blank"><img src="<?php echo ($vo["images"]); ?>" width="40" height="40" class="imgbg"></a></td>
            ...
            <td style="background-color: rgb(255, 255, 255);">
				<a class="recommendBtn" data-id="<?php echo ($vo["goods_id"]); ?>" data-status="<?php echo ($vo["is_recommend"]); ?>"><img src="/App/Admin/style/images/<?php if($vo["is_recommend"] == 1): ?>dui<?php else: ?>cuo<?php endif; ?>.png"></a>
			</td>
			<td style="background-color: rgb(255, 255, 255);">
