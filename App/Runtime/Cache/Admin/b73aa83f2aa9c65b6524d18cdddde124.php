...
<div class="content">
	...
	<a href="<?php echo U('User/index');?>">会员列表</a>
        ...
        <a href="<?php echo U('User/loginLog');?>" class="sel">代理商登录日志</a>
		<div class="clear"></div>
	</div>
	<div class="right_main">
		...
		<tbody><tr>
			...
			<th class="bgtt" width="100">登录名称</th>
			<th class="bgtt" width="120">登录ip</th>
			<th class="bgtt" width="200">登录地址</th>
			<th class="bgtt" width="200">登录结果</th>
			<th class="bgtt" width="200">登录信息</th>
			<th class="bgtt" width="130">登录时间</th>
		</tr>
        <?php if(is_array($data)): foreach($data as $key=>$vo): ?><tr>
    			...
    			<td style="background-color: rgb(255, 255, 255);"><?php echo ($vo["msg"]); ?></td>
